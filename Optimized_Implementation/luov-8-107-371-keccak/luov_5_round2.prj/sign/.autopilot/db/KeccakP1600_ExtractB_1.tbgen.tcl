set moduleName KeccakP1600_ExtractB_1
...
set C_modelName {KeccakP1600_ExtractB.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 200 { 1 1 } 1 1 }  }
	{ lanePosition int 32 regular  }
	{ data int 8 regular {array 8 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ data_address0 sc_out sc_lv 3 signal 2 } 
...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 3 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 8 } } }
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 8 }  { state_ce0 mem_ce 1 1 }  { state_q0 mem_dout 0 8 }  { state_address1 MemPortADDR2 1 8 }  { state_ce1 MemPortCE2 1 1 }  { state_q1 MemPortDOUT2 0 8 } } }
	data { ap_memory {  { data_address0 mem_address 1 5 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 8 }  { data_q0 mem_dout 0 8 }  { data_address1 MemPortADDR2 1 5 }  { data_ce1 MemPortCE2 1 1 }  { data_we1 MemPortWE2 1 1 }  { data_d1 MemPortDIN2 1 8 }  { data_q1 MemPortDOUT2 0 8 } } }
	data_offset { ap_none {  { data_offset in_data 0 64 } } }
	offset { ap_none {  { offset in_data 0 32 } } }
	length_r { ap_none {  { length_r in_data 0 32 } } }
}
