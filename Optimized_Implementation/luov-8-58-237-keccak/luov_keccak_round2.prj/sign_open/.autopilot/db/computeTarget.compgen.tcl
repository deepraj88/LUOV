...
set ID 167
set hasByteEnable 0
set MemName computeTarget_sposc4
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename target \
    op interface \
    ports { target_address0 { O 6 vector } target_ce0 { O 1 bit } target_we0 { O 1 bit } target_d0 { O 8 vector } target_q0 { I 8 vector } target_address1 { O 6 vector } target_ce1 { O 1 bit } target_we1 { O 1 bit } target_d1 { O 8 vector } target_q1 { I 8 vector } } \
} "
} else {
