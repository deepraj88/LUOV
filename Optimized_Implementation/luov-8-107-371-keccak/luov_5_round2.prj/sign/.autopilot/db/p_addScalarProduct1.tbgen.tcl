...
set C_modelArgList {
	{ V int 8 regular {array 12091 { 2 3 } 1 1 }  }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98", "Max" : "130"}
	, {"Name" : "Interval", "Min" : "98", "Max" : "130"}
]}
...
set Spec2ImplPortList { 
	V { ap_memory {  { V_address0 mem_address 1 14 }  { V_ce0 mem_ce 1 1 }  { V_we0 mem_we 1 1 }  { V_d0 mem_din 1 8 }  { V_q0 mem_dout 0 8 } } }
