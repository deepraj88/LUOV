...
set C_modelName {randombytes.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 8 regular {array 3794 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ x_offset sc_in sc_lv 64 signal 1 } 
		...
		"Port" : [
			...
			{"Name" : "DRBG_ctx_Key", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "2", "SubInstance" : "grp_AES256_CTR_DRBG_Upda_fu_177", "Port" : "DRBG_ctx_Key"}]},
