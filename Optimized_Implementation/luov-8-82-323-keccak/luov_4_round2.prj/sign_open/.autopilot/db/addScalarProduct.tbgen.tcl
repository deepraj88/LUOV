...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "103", "Max" : "263"}
	, {"Name" : "Interval", "Min" : "103", "Max" : "263"}
]}
...
set Spec2ImplPortList { 
	V { ap_memory {  { V_address0 mem_address 1 7 }  { V_ce0 mem_ce 1 1 }  { V_we0 mem_we 1 1 }  { V_d0 mem_din 1 8 }  { V_q0 mem_dout 0 8 }  { V_address1 MemPortADDR2 1 7 }  { V_ce1 MemPortCE2 1 1 }  { V_we1 MemPortWE2 1 1 }  { V_d1 MemPortDIN2 1 8 }  { V_q1 MemPortDOUT2 0 8 } } }
	a { ap_none {  { a in_data 0 8 } } }
	p_read { ap_none {  { p_read in_data 0 64 } } }
	p_read1 { ap_none {  { p_read1 in_data 0 64 } } }
}
