...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename publicseed \
    op interface \
    ports { publicseed_address0 { O 5 vector } publicseed_ce0 { O 1 bit } publicseed_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'publicseed'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename T \
    op interface \
    ports { T_address0 { O 8 vector } T_ce0 { O 1 bit } T_q0 { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename target \
    op interface \
    ports { target_address0 { O 6 vector } target_ce0 { O 1 bit } target_q0 { I 8 vector } } \
} "
} else {
