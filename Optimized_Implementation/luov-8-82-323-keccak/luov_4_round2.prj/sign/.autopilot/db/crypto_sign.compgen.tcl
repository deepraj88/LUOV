...
set ID 238
set hasByteEnable 0
set MemName crypto_sign_target
...
set ID 239
set hasByteEnable 0
set MemName crypto_sign_publiRg6
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 32
...
set ID 240
set hasByteEnable 0
set MemName crypto_sign_solutThq
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 406
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sm \
    op interface \
    ports { sm_address0 { O 12 vector } sm_ce0 { O 1 bit } sm_we0 { O 1 bit } sm_d0 { O 8 vector } sm_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 5 vector } sk_ce0 { O 1 bit } sk_q0 { I 8 vector } } \
} "
} else {
