...
set C_modelArgList {
	{ state int 8 regular {array 1400 { 0 0 } 0 1 }  }
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 11 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_address1 mem_address 1 11 }  { state_ce1 mem_ce 1 1 }  { state_we1 mem_we 1 1 }  { state_d1 mem_din 1 8 } } }
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 11 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_address1 MemPortADDR2 1 11 }  { state_ce1 MemPortCE2 1 1 }  { state_we1 MemPortWE2 1 1 }  { state_d1 MemPortDIN2 1 8 } } }
	state_offset { ap_none {  { state_offset in_data 0 3 } } }
}
set moduleName KeccakP1600_Initiali_1
set isTaskLevelControl 1
