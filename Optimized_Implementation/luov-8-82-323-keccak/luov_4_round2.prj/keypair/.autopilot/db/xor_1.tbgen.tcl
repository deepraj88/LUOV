...
set C_modelArgList {
	...
	{ a_components_offset int 7 regular  }
	{ a_components_offset1 int 7 regular  }
	{ b_0_components int 64 regular {array 84 { 1 3 } 1 1 }  }
	{ b_1_components int 64 regular {array 84 { 1 3 } 1 1 }  }
	{ b_components_offset int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_components", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
...
set Spec2ImplPortList { 
	a_components { ap_memory {  { a_components_address0 mem_address 1 14 }  { a_components_ce0 mem_ce 1 1 }  { a_components_we0 mem_we 1 1 }  { a_components_d0 mem_din 1 64 }  { a_components_q0 mem_dout 0 64 }  { a_components_address1 MemPortADDR2 1 14 }  { a_components_ce1 MemPortCE2 1 1 }  { a_components_we1 MemPortWE2 1 1 }  { a_components_d1 MemPortDIN2 1 64 }  { a_components_q1 MemPortDOUT2 0 64 } } }
	a_components_offset { ap_none {  { a_components_offset in_data 0 7 } } }
	a_components_offset1 { ap_none {  { a_components_offset1 in_data 0 7 } } }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "b_1_components", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "b_components_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.crypto_sign_keypair_mac_muladd_7ns_8ns_9ns_14_1_1_U134", "Parent" : "0"}]}
