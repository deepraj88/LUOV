set moduleName KeccakP1600_ExtractB_3
...
set C_modelName {KeccakP1600_ExtractB.3}
...
set C_modelArgList {
	...
	{ data int 8 regular {array 58 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ data_address0 sc_out sc_lv 6 signal 2 } 
	{ data_ce0 sc_out sc_logic 1 signal 2 } 
	{ data_we0 sc_out sc_logic 1 signal 2 } 
	{ data_d0 sc_out sc_lv 8 signal 2 } 
...
set Spec2ImplPortList { 
	...
	data { ap_memory {  { data_address0 mem_address 1 6 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 8 } } }
