...
set ID 704
set hasByteEnable 0
set MemName crypto_sign_keypair_TempMat
...
set ID 705
set hasByteEnable 0
set MemName crypto_sign_keypair_CG_states_sponge_sta
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 800
...
set ID 706
set hasByteEnable 0
set MemName crypto_sign_keypair_CG_blocks
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 256
...
set ID 707
set hasByteEnable 0
set MemName crypto_sign_keypair_temp
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 64
set AddrRange 3480
...
set ID 708
set hasByteEnable 0
set MemName crypto_sign_keypair_sponge_sponge_state
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 200
...
set ID 709
set hasByteEnable 0
set MemName crypto_sign_keypair_T
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 64
set AddrRange 238
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 14 vector } pk_ce0 { O 1 bit } pk_we0 { O 1 bit } pk_d0 { O 8 vector } pk_q0 { I 8 vector } pk_address1 { O 14 vector } pk_ce1 { O 1 bit } pk_we1 { O 1 bit } pk_d1 { O 8 vector } pk_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 5 vector } sk_ce0 { O 1 bit } sk_we0 { O 1 bit } sk_d0 { O 8 vector } sk_q0 { I 8 vector } } \
} "
} else {
